...
**Notice**: This project no longer works for automatic profile updates.
X.com (Twitter) has moved profile image updates to their Pro/Enterprise API tiers which cost $42,000+ per month.
As such, this repository has been permanently archived.
